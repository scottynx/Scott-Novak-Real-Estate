 ...
 return (
   <main className="min-h-screen bg-gray-50">
     ...
     <div className="max-w-3xl mx-auto p-8">
       <h1 className="text-3xl font-bold mb-8">SMS Terms and Conditions</h1>

       {/* General Terms */}
       <section className="mb-8">
         <h2 className="text-xl font-semibold mb-4">SMS Communication Terms</h2>
         <p className="mb-4">
       ...
       <section className="mb-8">
         <h2 className="text-xl font-semibold mb-4">How to Opt-Out</h2>
         <p className="mb-4">
