   ...
   <main className="min-h-screen bg-gray-50">
     ...
     <div className="max-w-3xl mx-auto p-4">
       <div className="text-center mb-8">
         <h2 className="text-2xl font-bold mb-2">Welcome to the Premarket Homes Portal</h2>
         <div className="text-gray-600">Get exclusive access to premarket properties in the Greater Sacramento Area!</div>
       </div>

       {/* Video Section */}
       <div className="mb-8">
         <h3 className="text-xl font-bold text-center mb-4">Watch the Explainer Video</h3>
       ...
       <div className="mb-8">
         <h3 className="text-xl font-bold text-center mb-4">Why Choose Us?</h3>
